...
const OUT = path.join("data", "campaigns.json");

// RSS oficial notícias do Ministério da Saúde
const FEEDS = [
  "https://www.gov.br/saude/pt-br/assuntos/noticias/noticias/RSS",
...
const KEYWORDS = [
  "campanha","vacina","vacinação","dengue","sarampo","influenza","zé gotinha",
  "prevenção","alerta","saúde","conscientização","caderneta","mutirão",
];
...
function lastDays(items, days=90){
...
async function main(){
  ...
  console.log(`OK: ${items.length} campaigns -> ${OUT}`);
}
